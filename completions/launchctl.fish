...
__complete_arg launchctl remove -a "(__suggest_service_plist_and_targets)"
__complete_arg launchctl kill -a "(__suggest_service_plist_and_targets)"
__complete_arg launchctl blame -a "(__suggest_service_plist_and_targets)"
