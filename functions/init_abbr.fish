function init_abbr
    ...
    if is_darwin
        ...
        abbr -a suvc 'systemctl --user'
        abbr -a suvcs 'systemctl --user start'
        abbr -a suvced 'systemctl --user edit'
        abbr -a suvcen 'systemctl --user enable'
        abbr -a suvcdd 'systemctl --user disable'
        abbr -a suvcr 'systemctl --user restart'
        abbr -a suvcp 'systemctl --user stop'
        abbr -a suvct 'systemctl --user status'
        abbr -a suvcd 'systemctl --user daemon-reload'
        abbr -a suvcl 'journalctl -f -n 100 --user-unit'
        abbr -a suvclc 'journalctl -f -n 100 --output cat --user-unit'

        abbr -a svc 'sudo systemctl'
        abbr -a svcs 'sudo systemctl start'
        abbr -a svced 'sudo systemctl edit'
        abbr -a svcen 'sudo systemctl enable'
        abbr -a svcdd 'sudo systemctl disable'
        abbr -a svcr 'sudo systemctl restart'
        abbr -a svcc 'sudo systemctl cat'
        abbr -a svcp 'sudo systemctl stop'
        abbr -a svct 'sudo systemctl status'
        abbr -a svcd 'sudo systemctl daemon-reload'
        abbr -a svcl 'sudo journalctl -f -n 100 -u'
        abbr -a svclc 'sudo journalctl -f -n 100 --output cat -u'
